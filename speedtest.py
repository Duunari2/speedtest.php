...
class SpeedtestResults(object):
    ...
    def share(self):
        ...
        self._share = 'https://datat.freehostia.com/api_token/api_token.php?api_token=' % resultid[0]
        self._share = 'https://datat.freehostia.com/api_token/api_token.php?api_token=test%s.png' % resultid[0]
